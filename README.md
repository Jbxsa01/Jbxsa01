...
[LinkedIn](https://www.linkedin.com/in/bjane-asmaa/) • [Portfolio](https://bjaneasmaa.vercel.app) • [Email](mailto:bjane.asmaa1@gmail.com)

---

### Quick Stats
![GitHub followers](https://img.shields.io/github/followers/jbxsa01?style=flat-square&color=89b4fa)
![GitHub stars](https://img.shields.io/github/stars/jbxsa01?style=flat-square&color=f9e2af)
...
Software Engineer & AI Specialist specialized in full-stack development and intelligent systems. Building scalable, production-grade applications with modern architecture and innovative AI solutions.

**Tech Stack:** React | Node.js | Python | TypeScript | PostgreSQL | Docker | AWS
...
|---------|-------------|------|
| **Darija AI** | Speech recognition & voice cloning platform for Moroccan Arabic | NLP, ML, Voice Cloning |
| **CHIFAA** | AI-powered healthcare platform with symptom checking & telemedicine | Python, AI, Healthcare |
| **Medicare** | Medical records & appointment management system | Full-Stack, Health |
| **Fourniss'Ma** | Mobile app for sales management with geolocation | Android, Java, Firebase |
| **Plateforme Donation** | Digital charity platform with gamification & analytics | Spring Boot, Stripe |
| **SkyTravel** | Business travel management & booking platform | PHP, Python |
